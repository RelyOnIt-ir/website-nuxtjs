    ...
    <div class="hero-body">
      ...
      <h2 class="subtitle">
        ...
        <b-tag type="is-success" size="is-large" class="p-5 has-text-weight-normal rtl">
          تلفن تماس: <span class="is-size-4 has-text-weight-bold" style="letter-spacing: 2px;">۰۲۱۲۸۴۲۹۱۸۲</span>
        ...
        <b-tag type="is-success" size="is-large" class="p-5 has-text-weight-normal rtl">
          ایمیل: <span class="is-size-4 has-text-weight-bold">relyonit.ir@gmail.com</span>
