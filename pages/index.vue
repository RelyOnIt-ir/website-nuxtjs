          ...
          <div class="columns is-vcentered">
            ...
            is-4-fullhd is-offset-1-fullhd">
              <figure class="image is-square">
                <img :src="require('~/assets/images/undraw_Server_re_twwj.svg')">
              </figure>
            </div>
            ...
            is-5-fullhd is-offset-1-fullhd" data-aos="fade-down">
              ...
              <h2 class="subtitle has-text-grey is-4 has-text-weight-normal has-text-right">
                ما با بهره گیری از تکنولوژی های جدید و تجربه های متعدد، پایداری سیستم های نرم افزاری و سرعت توسعه تان را بهبود می دهیم
              </h2>
              <div class="buttons">
                <a class="button is-success" href="#contact-us">ارتباط با ما</a>
                <a class="button" href="#contact-us">درخواست مشاوره</a>
              </div>
            </div>
...
export default {
  data: () => ({
    testomonials: [
      ...
      {
        text: 'اگر به دنبال داشتن زیرساخت پایدار در هر شرایطی هستید، Relyonit بهترین گزینه اس. این تیم متشکل از افرادیه که بازیکنان تیمی ایده آل هستند، چرا که در کارشون فروتن، پرولع و هوشمند عمل می کنند و ما در همکاری باهاشون این رو به عینه شاهد بودیم.',
        name: 'محسن رجبی',
        link: 'https://www.linkedin.com/in/mohsen-rajabi-48803b99',
        role: 'مدیر',
        brand: 'پرسان',
        website: 'https://porsan.ir'
      }
    ]
  })
}
