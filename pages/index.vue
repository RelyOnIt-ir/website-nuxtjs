...
export default {
  data: () => ({
    testomonials: [
      ...
      {
        text: 'اگر به دنبال داشتن زیرساختی پایدار هستید، Relyonit بهترین گزینه اس. این تیم متشکل از افرادیه که بازیکنان تیمی ایده آل هستند، چرا که در کارشون فروتن، پرولع و هوشمند عمل می کنند و ما در همکاری باهاشون این رو به عینه شاهد بودیم.',
        name: 'محسن رجبی',
